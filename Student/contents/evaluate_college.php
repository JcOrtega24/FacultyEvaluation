...
<div style="width: 90%; margin-left: 5%;">
	<div class="table-main card card-outline">
		<form id="manage-evaluation" novalidate>	
			<div class="card-body">			
				<h4 class="text-center"><b>Faculty Performance Evaluation Form</b></h4>
				<?php
				...
				?>	
				<label for="" class="control-label">Name of Faculty: <?php echo $faculty['firstname']." ".$faculty['middlename']." ".$faculty['lastname'] ?></label>
				</div>
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="form-group">
							<label for="" class="control-label">Semester: <?php echo $schoolyear['semester'] ?></label>
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="form-group">
							<label for="" class="control-label">Institution: <?php echo $class['department'] ?></label>
						</div>
					</div>
				</div>
				<fieldset>
								...
								<?php for($c=4; $c>=1; $c--): ?>
									<td class="text-center" style="padding-left: 19px">
										<div class="icheck-success d-inline">
											<input type="radio" class="rate-option" required name="rate[<?php echo $row['id'] ?>]" <?php //echo $c == 1 ? "checked" : '' ?> id="qradio<?php echo $row['id'].'_'.$c ?>" value="<?php echo $c ?> ">
