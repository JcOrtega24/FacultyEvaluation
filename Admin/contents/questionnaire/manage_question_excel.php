...
<div class="container-fluid">
    <form action="" id="manage-questionnaire" enctype="multipart/form-data" method="post">
...
<script>
    $(document).ready(function() {
        $('#manage-questionnaire').on('submit', function(e) {
            e.preventDefault();
            ...
            reader.onload = function(e) {
                ...
                $.ajax({
                    url: 'ajax.php?action=save_question_excel',
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
